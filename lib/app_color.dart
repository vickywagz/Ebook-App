...
final Color backgroud = Color(0xFFfafafc);
final Color sliverBackground = Color(0xFfafafc);
final Color menu1Color = Color(0xFFf9d263);
final Color menu2Color = Color(0xFFf2603d);
final Color menu3Color = Color(0xF04abe6);
final Color tabVarViewColor = Color(0xFFffdfdfd);
final Color starColor = Color(0xFFfdc746);
final Color subitleText = Color(0xFFc5c4ca);
